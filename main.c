...
* Macros
*******************************************************************************/
#define PIN_ADC (P10_0)              //pin a utilizar.
#define ACQUISITION_TIME_NS (1000u)  //tiempo de muestreo.
#define CONVERSION_A_MILI (1000u)    //constante para la conversion a mili volt.
int32_t voltaje;
float32_t tem;
...
int main(void)
{
    ...
    for (;;)
    {
    	 ...
    	 tem = (voltaje/10.00);
    	 printf("VOLTAJE EN mV: %4ldmV\r\n", (long int)voltaje);
    	 printf("TEMPERATURA °C: %0.1f°C\r\n", (float)tem);
